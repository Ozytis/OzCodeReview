        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Branch = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Commit = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommentatorId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StartLineNumber = table.Column<int>(type: "int", nullable: false),
                    EndLineNumber = table.Column<int>(type: "int", nullable: false),
                    StartCharIndex = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_CommentatorId",
